...
namespace NetProject.Migrations
{
    ...
    [Migration("20250609081909_AddWorkOrderComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetProject.Models.WorkOrderComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetProject.Models.ServiceTask", b =>
                {
                    b.HasOne("NetProject.Models.ServiceOrder", null)
                        .WithMany("ServiceTasks")
                        .HasForeignKey("ServiceOrderId");

                    b.HasOne("NetProject.Models.WorkOrder", "WorkOrder")
                        .WithMany("ServiceTasks")
